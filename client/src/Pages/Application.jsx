...
import { FileText, UploadCloud, BarChart3, TrendingUp, Clock, AlertTriangle, CheckCircle2, XCircle, Hourglass, Target, ArrowUpRight, ChevronDown, ChevronUp, Folder, Github, Linkedin, Globe, Plus } from 'lucide-react'
              ...
              <div className='flex flex-col items-end gap-2'>
                <div className='flex gap-2'>
                  {userData.links?.github ? (
                    ...
                    <button onClick={() => setEditLinks(true)} className='group flex h-9 w-9 items-center justify-center rounded-xl bg-slate-50 border border-slate-200 border-dashed text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors cursor-pointer' title='Add GitHub'>
                      <Github size={16} className='group-hover:hidden' />
                  ...
                  {userData.links?.linkedin ? (
                    ...
                    <button onClick={() => setEditLinks(true)} className='group flex h-9 w-9 items-center justify-center rounded-xl bg-blue-50 border border-blue-100 border-dashed text-blue-400 hover:bg-blue-100 hover:text-blue-600 transition-colors cursor-pointer' title='Add LinkedIn'>
                      <Linkedin size={16} className='group-hover:hidden' />
                      <Plus size={16} className='hidden group-hover:block' />
                    </button>
                  )}
                  ...
                  {userData.links?.portfolio ? (
                    ...
                    <button onClick={() => setEditLinks(true)} className='group flex h-9 w-9 items-center justify-center rounded-xl bg-purple-50 border border-purple-100 border-dashed text-purple-400 hover:bg-purple-100 hover:text-purple-600 transition-colors cursor-pointer' title='Add Portfolio'>
