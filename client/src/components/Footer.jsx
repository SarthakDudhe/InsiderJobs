  ...
  return (
    <footer className='border-t border-slate-200 bg-white text-slate-950'>
      <div className='ij-container flex flex-col items-center justify-between gap-6 py-8 sm:flex-row'>
        ...
        <p className='flex-1 text-center text-[13px] text-slate-500 sm:border-l sm:border-slate-200 sm:pl-5 sm:text-left'>
          Copyright @SarthakDudhe | All rights reserved.
        </p>
        <div className='flex flex-row gap-3 opacity-70 grayscale'>
